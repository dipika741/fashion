    ...
    <div class="row no-gutters pb-5">
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="{{ asset('images/a1.jpg') }}" alt="">
                <div class="overlay">
        ...
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="{{ asset('images/a2.jpg') }}" alt="">
                <div class="overlay">
                    <h5>men's fashion</h5>
        ...
        <div class="col-sm-4">
            <div class="hovereffect">
                <img class="img-fluid" src="{{ asset('images/a3.jpg') }}" alt="">
                <div class="overlay">
                    <h5>kid's fashion</h5>
                ...
                <div role="tabpanel" class="tab-pane fade show active" id="women" aria-labelledby="women-tab">
                    <div id="owl-demo" class="owl-carousel text-center">
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pf1.jpg') }}" alt="img" class="card-img-top">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pf2.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pf3.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pf9.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pf11.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">
                    <div id="owl-demo1" class="owl-carousel text-center">
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pm1.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pm2.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pm11.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pt1.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pt2.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class=" card product-men p-3 ">
                                <div class="men-thumb-item ">
                                    <img src="{{ asset('images/pt3.jpg') }} " alt="img " class="card-img-top ">
                                    <div class="men-cart-pro ">
                                        <div class="inner-men-cart-pro ">
                                            <a href="mens.html " class="link-product-add-cart ">Quick View</a>
                                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="boy" aria-labelledby="boy-tab">
                    <div id="owl-demo3" class="owl-carousel text-center">
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb1.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb2.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb3.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3 out_w3">
                                <div class="men-thumb-item position-relative">
                                    <img src="{{ asset('images/pb7.jpg') }}" alt="img" class="card-img-top">
                                    <span class="px-2 position-absolute">out of stock</span>
                                </div>
                                <!-- card body -->
                                <div class="card-body  py-3 px-2">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb4.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb5.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb6.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb8.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img src="{{ asset('images/pb9.jpg') }}" alt="img" class="card-img-top">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                        </div>
    ...
    <section class="py-lg-5">
        ...
        <div class="gallery row no-gutters pt-lg-5">
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i1.jpg') }}" class="img-fluid" alt="" />
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i2.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i3.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i4.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i5.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 38</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i6.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 38</li>
        ...
        <div class="gallery row no-gutters pb-5">
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i7.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 56</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i8.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 89</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i9.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 42</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i10.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 38</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i11.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 38</li>
            ...
            <div class="col-lg-2 col-sm-4 col-6 gallery-item">
                <img src="{{ asset('images/i12.jpg') }}" class="img-fluid" alt="" />
                <div class="gallery-item-info">
                    <ul>
                        <li class="gallery-item-likes">
                            <i class="fas fa-heart"></i> 38</li>
