        ...
        <div class="container">
            ...
            <div class="row card-columns py-lg-5">
                <div class="col-md-4 p-0">
                    <div class="card">
                        <a href="single.html">
                            <img class="card-img-top" src="{{ asset('images/blg1.jpg') }}" alt="Card image cap">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-md-4 0">
                    ...
                    <div class="card text-white text-center">
                        <a href="single.html">
                            <img class="card-img" src="{{ asset('images/a3.jpg') }}" alt="Card image">
                        </a>
                ...
                <div class="col-md-4 p-0">
                    <div class="card">
                        <a href="single.html">
                            <img class="card-img" src="{{ asset('images/blg2.jpg') }}" alt="Card image">
                        </a>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <a href="single.html">
                            <img class="card-img-top" src="{{ asset('images/i10.jpg') }}" alt="Card image cap">
                        </a>
                    </div>
                </div>
            </div>
