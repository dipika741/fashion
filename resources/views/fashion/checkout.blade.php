                    ...
                    <table class="timetable_sub">
                        ...
                        <tbody>
                            <tr class="rem1">
                                ...
                                <td class="invert-image">
                                    <a href="single_product.html">
                                        <img src="{{ asset('images/pm1.jpg') }}" alt=" " class="img-responsive">
                                    </a>
                                </td>
                                <td class="invert">
                                    <div class="quantity">
                            ...
                            <tr class="rem2">
                                ...
                                <td class="invert-image">
                                    <a href="single_product.html">
                                        <img src="{{ asset('images/pf1.jpg') }}" alt=" " class="img-responsive">
                                    </a>
                                </td>
                                <td class="invert">
                                    <div class="quantity">
                            ...
                            <tr class="rem3">
                                ...
                                <td class="invert-image">
                                    <a href="single_product.html">
                                        <img src="{{ asset('images/pb3.jpg') }}" alt=" " class="img-responsive">
                                    </a>
                                </td>
                                <td class="invert">
                                    <div class="quantity">
...
@section('script')
    ...
    <!--// FadeOut-Script -->
<!-- end of added from checkout.html -->
